...
Минимальный Docker-стек с reverse proxy на Nginx и Go-бэкендом, изолированным во внутренней Docker-сети.
...
В Compose для сервиса настроен healthcheck на `http://localhost:8080/health`.
